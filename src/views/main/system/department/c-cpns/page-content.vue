  ...
  <div class="content">
    ...
    <div class="table">
      <el-table :data="pageList" border style="width: 100%">
        ...
        <el-table-column prop="name" label="部门名称" width="120px" />
        <el-table-column prop="realname" label="部门领导" width="120px" />
        <el-table-column prop="parentId" label="上级部门" width="120px" />
