    ...
    >
      <defs>
        ...
        <image
          ...
          width="23"
          height="23"
          :href="getAssetsFile('center/image-1.png')"
        />
        <image
          id="image-2"
          width="15"
          height="15"
          :href="getAssetsFile('center/image-2.png')"
        />
      </defs>
      <g id="dongxiao1">
        <g id="icon">
          ...
          <image
            ...
            width="112"
            height="112"
            :href="getAssetsFile('center/star.png')"
          />
          <path
            id="base_o-2"
            data-name="base_o"
          ...
          <image
            ...
            width="106"
            height="107"
            :href="getAssetsFile('center/location.png')"
          />
          <path
            id="base_o-3"
            data-name="base_o"
          ...
          <image
            ...
            width="107"
            height="108"
            :href="getAssetsFile('center/pie.png')"
          />
          <path
            id="base_o-4"
            data-name="base_o"
          ...
          <image
            ...
            width="111"
            height="112"
            :href="getAssetsFile('center/earth.png')"
          />
          <path
            id="base_o-5"
            data-name="base_o"
          ...
          <image
            ...
            width="105"
            height="105"
            :href="getAssetsFile('center/hot.png')"
          />
          <path
            id="base_o-6"
            data-name="base_o"
          ...
          <image
            ...
            width="103"
            height="103"
            :href="getAssetsFile('center/home.png')"
          />
        </g>
        <g id="circle">
          <path
          ...
          <image
            ...
            width="72"
            height="92"
            :href="getAssetsFile('center/light_0_3.png')"
          />
          <image
            id="light_o_2"
            x="141"
            ...
            width="99"
            height="137"
            :href="getAssetsFile('center/light_0_2.png')"
          />
          <image
            id="light_o_1"
            x="436"
            ...
            width="99"
            height="66"
            :href="getAssetsFile('center/light_0_1.png')"
          />
        </g>
        <image
          id="center"
          ...
          width="539"
          height="419"
          :href="getAssetsFile('center/house.png')"
        />
        <g id="right">
          <g id="组_380" data-name="组 380">
            ...
            <g id="dots_b">
              ...
              <image
                ...
                width="22"
                height="23"
                :href="getAssetsFile('center/dots28.png')"
              />
              <circle
                id="dots27"
                class="cls-40"
...
#icon_home_foshan {
  animation: updown 1.8s ease-in infinite;
}
